...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="lazy-section py-20 px-4 md:px-8 bg-[color-mix(in_srgb,var(--bg-color)_50%,transparent)]">
        ...
        <div className="flex flex-col gap-4">
          {faqs.map((faq, index) => (
            <motion.div 
              ...
              className={`clay-sm overflow-hidden transition-all duration-300 ${openIndex === index ? 'ring-2 ring-primary/20' : ''}`}
            >
              <button 
